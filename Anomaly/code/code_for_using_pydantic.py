...
class ThresholdBreachItem(BaseModel):
    ...
    measuredValue: Optional[float] = Field(
        None,
...
class Anomaly(BaseModel):
    ...
    anomalousProperty: Optional[str] = Field(
        None,
    ...
    dateDetected: Optional[str] = Field(
        None, description='The date and time at which the anomaly was first detected'
    )
    ...
    detectedBy: Optional[AnyUrl] = Field(
        None, description='The ID of the device at which the anomaly was detected'
    )
    id: Optional[
        Union[
            constr(
    ...
    thresholdBreach: Optional[List[ThresholdBreachItem]] = Field(
        None,
        description='Description of an observed threshold breach that contributed to detection of an anomaly',
    )
    type: Optional[Type6] = Field(
        None, description='NGSI-LD Entity Type. It has to be Anomaly'
    )
