...
[사양 링크](https://github.com/smart-data-models/dataModel.Alert/blob/master/Anomaly/doc/spec_KO.md)
### Examples
...
Link to the [PostgreSQL schema](https://github.com/smart-data-models/dataModel.Alert/blob/master/Anomaly/schema.sql) of this data model
### Contribution
